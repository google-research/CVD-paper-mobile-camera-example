...
object FingernailsClosedPhotoSensorCaptureViewHolderFactory :
  ...
  override fun getQuestionnaireItemViewHolderDelegate() =
    object : QuestionnaireItemViewHolderDelegate {
      ...
      override fun init(itemView: View) {
        ...
        takePhotoButton.text = "Capture Fingernails Closed Photo"
      ...
      private fun displayOrClearInitialPreview() {
        ...
        answer.valueCoding?.let { code ->
          ...
          livePath.observe(context) {
            displayPreview(attachmentTitle = "Fingernails Closed", attachmentUri = it)
          }
        }
      }
        ...
        context.supportFragmentManager
          ...
          .replace(
            ...
            InstructionsFragment().apply {
              arguments =
                bundleOf(
                  InstructionsFragment.LAYOUT to R.layout.fragment_fingernails_closed_instructions
                )
            }
          )
          .setReorderingAllowed(true)
  ...
  const val WIDGET_TYPE = "photo-fingernails-closed-capture"
}
