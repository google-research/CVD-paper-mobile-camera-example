...
sealed class UploadResult {
  ...
  data class Success(override val uploadRequest: UploadRequest, val bytesUploaded: Long, val lastUploadTime: Date): UploadResult()

  data class Completed(override val uploadRequest: UploadRequest, val completeTime: Date): UploadResult()
