 ...
 *
 * <p>This is effectively a {@link java.util.function.Supplier}, but intended to be used from
 * within a ReactiveStreams {@link org.reactivestreams.Subscriber} or
 * {@link org.reactivestreams.Processor}. A common use case is in supplying {@link java.io.File}s to
 * save results from the stream.
 */
@CheckReturnValue 
public interface FlowSupplier<I, O> {
  ...
  /**
   * Performs cleanup functions after the stream has been terminated with {@code #onNext} or
   * {@code #onComplete}.
   */
